...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    domains: [
      ...
      'cdn.turing.com',
      'jawalplus.com',  // إضافة هذا النطاق
      'mob4g.com',      // إضافة هذا النطاق
    ],
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'jawalplus.com', pathname: '/**' },  // إضافة هذا النطاق
      { protocol: 'https', hostname: 'mob4g.com', pathname: '/**' },      // إضافة هذا النطاق
    ],
  },
  env: {
