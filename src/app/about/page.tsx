...
export const metadata = {
  title: 'من نحن - برج الجوال',
  description: 'تعرف على برج الجوال، متجر إلكتروني يقدم أحدث الهواتف والإكسسوارات مع خدمة توصيل سريعة.',
}
    ...
    <div className="bg-white text-gray-900 min-h-screen pt-24 px-6 font-[Cairo]">
      <div className="max-w-3xl mx-auto bg-white border border-gray-200 p-8 rounded-2xl shadow-sm">
        ...
        <p className="text-lg mb-4 leading-relaxed">
          متجر <strong>برج الجوال</strong> هو متجر إلكتروني متخصص في بيع الهواتف الذكية
كية
. نهدف لتقديم منتجات عالية الجودة بأسعار تنافسية مع تجربة تسوق سهلة وسريعة.
        </p>
